...
// Centered modal primitive — distinct from `sheet.tsx`'s right-side slide-in
// (`4-ui/4-component-standards.md` Overlay Components lists both shapes). First use:
// `TransferTargetPicker` (T-030).
    ...
    <DialogPortal>
      ...
      >
        ...
        <DialogPrimitive.Close
          ...
          className="text-muted-foreground hover:bg-accent absolute top-4 right-4 flex size-8 items-center justify-center rounded-md"
        >
