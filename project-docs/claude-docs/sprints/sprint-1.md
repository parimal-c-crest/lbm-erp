...
|-------|-----|------|----------|--------|-------------|
| 1 | T-001 | Initialize Git repository, connect GitHub remote, base `.gitignore`/README | S | In Progress | |
| 2 | T-002 | Set up pnpm workspace (`pnpm-workspace.yaml`, root `package.json`) | S | Available | |
